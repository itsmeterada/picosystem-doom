...
#else // ORIGINAL_RP2040_DOOM_LCD
        display = new SSD1306(70, 40, PICO_DEFAULT_SPI_INSTANCE, /*baudrate*/ 8000 * 1000, /*mosi*/ PICO_DEFAULT_SPI_TX_PIN, /*cs*/ PICO_DEFAULT_SPI_CSN_PIN, /*sclk*/ PICO_DEFAULT_SPI_SCK_PIN, /*reset*/ 21, /*dc*/ 20);
#endif // ORIGINAL_RP2040_DOOM_LCD
        display->init();    
